...
function renderChapters() {
  ...
  const chapterPDFs = S.chapterPDFs && typeof S.chapterPDFs === 'object' ? S.chapterPDFs : {};
  el.innerHTML = chapters.map((ch, i) => {
    const sourceSection = sourceSections.find(section => section && section.file === ch.fileName);
    const sourceUrl = ch.sourceUrl || sourceSection?.url || '';
    const pageCount = Array.isArray(chapterPDFs[ch.id]) ? chapterPDFs[ch.id].length : (sourceSection?.pageCount || 0);
    ...
    return `
      <div class="chapter-item">
        ...
        <div style="display:flex;gap:5px;flex-shrink:0">
          ...
          ${i < chapters.length - 1 ? `<button class="btn btn-xs btn-outline" onclick="moveChapter(${i},1)">Down</button>` : ''}
...
/* js/modules/replenishment/sidebar.js */
(function() {
class Sidebar {
  constructor() {
...
/* js/modules/replenishment/workspace.js */
(function() {
class Workspace {
  init(module) {
    this.module = module;
...
/* js/modules/replenishment/preview.js */
(function() {
class Preview {
  init(module) {
    this.module = module;
...
/* js/modules/replenishment/index.js */
(function() {
